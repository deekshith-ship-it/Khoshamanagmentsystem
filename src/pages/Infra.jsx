...
import { Database, Globe, Server, Trash2, Plus, Box, Shield, Zap, Search } from 'lucide-react';
            ...
            {loading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 stagger-children">
                    {filteredAssets.map((asset) => {
                        ...
                        return (
                            <Card key={asset.id} className="group card-hover hover:border-primary-200 dark:hover:border-primary-900/50 transition-all">
                                ...
                                <div className="space-y-3 mb-6">
                                    {asset.domain_name && (
                                        <div className="flex items-center justify-between text-xs font-medium">
                                            ...
                                            <span className="text-gray-900 dark:text-white truncate max-w-[180px]">{asset.domain_name}</span>
                                        </div>
                                    )}
                                    {asset.expire_date && (
                                        <div className="flex items-center justify-between text-xs font-medium">
